...
typedef BOOL (WINAPI *PDETOUR_CREATE_PROCESSLOGON_ROUTINEA)
    (HANDLE hToken,
     LPCSTR lpApplicationName,
     LPSTR lpCommandLine,
     LPSECURITY_ATTRIBUTES lpProcessAttributes,
...
typedef BOOL (WINAPI *PDETOUR_CREATE_PROCESSLOGON_ROUTINEW)
    (HANDLE hToken,
     LPCWSTR lpApplicationName,
     LPWSTR lpCommandLine,
     LPSECURITY_ATTRIBUTES lpProcessAttributes,
...
BOOL WINAPI DetourCreateProcessWithDll(LPCWSTR lpApplicationName,
                                        LPWSTR lpCommandLine,
                                        LPSECURITY_ATTRIBUTES lpProcessAttributes,
                                        LPSECURITY_ATTRIBUTES lpThreadAttributes,
                                        BOOL bInheritHandles,
